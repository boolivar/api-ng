...
public enum GroupBy {
	...
	/** An averaged roll up of settled P&L, and number of bets, on the specified side
	 * of a specified selection within a specified market, that are either settled or voided */
	SIDE,
